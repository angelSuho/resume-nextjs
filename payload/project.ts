  ...
  list: [
    {
      ...
      startedAt: '2023-04',
      where: '강남대학교 2023년 10월 백양체전 축제 페이지',
      descriptions: [
        ...
        { content: '정적 데이터 캐싱, 쿼리 최적화 등 비즈니스 로직 개선' },
        ...
        { content: '매일 PR을 올리고 상호간 코드 리뷰를 통해 협업 능력 향상' },
        {
          ...
          weight: 'MEDIUM',
          descriptions: [
            { content: 'SpringBoot 3.x, JPA, Querydsl, Redis, MariaDB, H2, JUnit5, Mockito, Github Actions, AWS-EC2, S3, RDS' },
          ],
        },
      ],
    },
    {
      ...
      descriptions: [
        ...
        { content: '재고에 대한 동시성 문제를 Redis의 분산락을 활용해 해결',
          weight: 'MEDIUM', 
        },
        ...
        { content: '정적 데이터 캐싱처리와 쿼리최적화를 통해 조회에 대한 평균 응답시간 20%, TPS 약 22% 향상' },
        {
          content: '기술 스택',
          weight: 'MEDIUM',
          descriptions: [
            { content: 'SpringBoot 3.x, JPA, Querydsl, Mysql, H2, Redis, JUnit5, Mockito, k8s, Kafka, Nginx, PinPoint, NCP, Github Actions' },
          ],
        },
      ],
    },
